...
```
    ...
    <matplotlib.collections.PathCollection at 0x7f8e7240c590>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7f8e72341a50>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7f8e722b63d0>
...
```
    ...
    (0.8096256684491973, 0.5208556149732612)
...
```
    ...
    /home/travis/miniconda/envs/nams/lib/python3.7/site-packages/seaborn/categorical.py:1296: UserWarning: 8.0% of the points cannot be placed; you may want to decrease the size of the markers or use stripplot.
...
![png](images/04-advanced_03-stats_md_47_2.png)
